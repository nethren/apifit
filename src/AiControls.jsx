...
export function AiControls({ status, enabled, onEnabled, onRefresh, onClose, onDone = onClose, context = '' }) {
  return <Dialog title="AI assistance" onClose={onClose}>
    ...
    {status?.budget && <p><strong>US${status.budget.remainingUsd.toFixed(3)} remaining</strong> of your US$5 development budget. Pending or uncertain charges stay reserved.</p>}
